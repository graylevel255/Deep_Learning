...
weights = {
    ...
    'decoder_h1': tf.Variable(tf.random_normal([h2, h1], seed = 3)*0.01),
    'decoder_h2': tf.Variable(tf.random_normal([h1, ip_dim], seed = 4)*0.01),
...
biases = {
    ...
    'decoder_b1': tf.Variable(tf.random_normal([h1], seed = 10)*0.01),
    'decoder_b2': tf.Variable(tf.random_normal([ip_dim], seed = 11) * 0.01),
}
